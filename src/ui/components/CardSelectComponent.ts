...
export class CardSelectComponent {
  ...
  public onAnswer: ((pairId: string, answer: number | string) => void) | null =
    null;
  ...
  private getStandardAnswerText(qCard: QuestionCard): string {
    if (qCard.question.type === "fill" || !qCard.question.options) {
      return typeof qCard.question.answer === "string"
  ...
  private updateButtons(
    ...
    const isCurrentFace =
      (isVisualFront && pair.currentFace === CardFaceState.Front) ||
