...
export class ResourceManager {
  ...
  public async loadAll(): Promise<void> {
    ...
    try {
      ...
      const images = import.meta.glob("../../assets/image/*.{png,jpg,jpeg}", {
        query: "?url",
        import: "default",
        eager: true,
      });
      const audio = import.meta.glob("../../assets/music/*.{mp3,wav,ogg}", {
        query: "?url",
        import: "default",
        eager: true,
      });
      const modelsInSrc = import.meta.glob(
        "../../assets/model/**/*.{glb,gltf}",
        { query: "?url", import: "default", eager: true },
      );
      const modelsInRoot = import.meta.glob("../../../assets/**/*.{glb,gltf}", {
        query: "?url",
        import: "default",
        eager: true,
      });
